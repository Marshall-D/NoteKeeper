...
class DataManager private constructor() {
    ...
    fun initializeExampleNotes() {
        ...
        mNotes.add(NoteInfo(course, "Dynamic intent resolution",
                "Wow, intents allow components to be resolved at runtime"))
        mNotes.add(NoteInfo(course, "Delegating intents",
        ...
        mNotes.add(NoteInfo(course, "Service default threads",
                "Did you know that by default an Android Service will tie up the UI thread?"))
        mNotes.add(NoteInfo(course, "Long running operations",
        ...
        mNotes.add(NoteInfo(course, "Parameters",
                "Leverage variable-length parameter lists"))
        mNotes.add(NoteInfo(course, "Anonymous classes",
        ...
        mNotes.add(NoteInfo(course, "Compiler options",
                "The -jar option isn't compatible with with the -cp option"))
        mNotes.add(NoteInfo(course, "Serialization",
